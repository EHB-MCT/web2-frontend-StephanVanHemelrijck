...
!(function (t, i) {
    ...
    function oi(t, i) {
        ...
        return (
            (n && "auto" !== n) || !document.defaultView || (n = (e = document.defaultView.getComputedStyle(t, null)) ? e[i] : null), "auto" === n ? null : n
        );
    }
    function si(t, i, e) {
            ...
            _fireDOMEvent: function (t, i, e) {
                ...
                if (
                    ...
                    for (var a = 0; a < e.length; a++)
                        if ((e[a].fire(i, r, !0), r.originalEvent._stopped || (!1 === e[a].options.bubblingMouseEvents && -1 !== v(this._mouseEvents, i))))
                            return;
                }
            },
            ...
            if (this._map && !it) {
                ...
                for (var n in this._tiles) {
                    ...
                    s.current &&
                        ...
                        mi(s.el, o),
                        o < 1 ? (i = !0) : (s.active ? (e = !0) : this._onOpaqueTile(s), (s.active = !0)));
                }
